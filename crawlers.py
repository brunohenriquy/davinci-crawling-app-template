...
from {{ app_name | lower }}.utils import \
    get_from_date, RESET_FROM_DATE_ARG, FROM_DATE_ARG, \
    LAST_EXECUTION_DATE_CTL_FIELD

from .models import {{ app_name | capfirst }}Resource, SITUATION_GRANTED
...
class {{ app_name | capfirst }}Crawler(Crawler):
    ...
    def crawl(self, crawling_params, options):
        ...
        {{ app_name | capfirst }}Resource.create(**params)
